        ...
        <>
            <footer className='2xl:container 2xl:mx-auto bg-base-300 text-base-content p-5 mt-24'>
                <section className='container mx-auto p-5'>
                    ...
                    <div className="footer grid grid-cols-2 md:grid-cols-3">
                ...
                <div className='text-center mt-14'>
                    <p>All &copy;copyright are reserved by <a href="https://facebook.com/mrreja.me" target='_blank' className='text-green-600 font-bold'>Rejaul Islam</a></p>
                </div>
            </footer>
